    ...
    private fun info(): Info {
        return Info().apply {
            ...
            description = """<h2>Article API</h2>
                <p>You can See Full Source Code at <a target="_blank" href="${gitProperties.remote.origin.url}">GitHub Repository</a></p>
                ...
                <p><strong>Commit ID:</strong> <a target="_blank" href="${gitProperties.remote.origin.url.removeSuffix(".git")}/commit/${gitProperties.commit.id}">${gitProperties.commit.id}</a></p>
                <p><strong>Commit Time:</strong> ${gitProperties.commit.time}</p>
                <p><strong>Committed by:</strong> ${gitProperties.commit.user.name} (<a href="mailto:${gitProperties.commit.user.email}">${gitProperties.commit.user.email}</a>)</p>
            """.trimMargin()
            termsOfService = ""
